...
$(document).on('click', '#tomar_cam_mini', function () {
    Webcam.snap( function(dataurl) {
      SubirFotoEst(ruta, dataurl, ide, urlcdn, 1);
  ...
  var xwidth = $(this).attr('xwidth');
   ...
   var file = this.files[0];
      ...
      .then(function () {
       ...
       SubirFotoEst(ruta, dataurl, ide, urlcdn);
...
function SubirFotoEst(ruta, dataurl, ide, urlcdn, cam=0){
  ...
  $.ajax({
    ...
    .done(function (e) {
      ...
      var srcfoto = urlcdn + '/imagenes/fotos/estudiantes/foto_' + ide + '.jpg?v=' + `${new Date().getTime()}`;
