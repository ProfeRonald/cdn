 ...
 $(document).on('click focus', '#TablaCalificaciones_paginate, #TablaCalificaciones_paginate .pagination', function () {
  ...
  window.SumaPs = function (id_nota) {
    ...
    if(notap < ponderacion_academica && notap > 0){
      ...
      $('#comp-'+id_nota+'-rp').attr('data-content', tp + '<span style="font-size: 1rem">=' + notap + ' + <div class="fraccion"><span class="dividendo">' + parseFloat((nota / 100 * (100 - notap))).toFixed(0) + '</span><span class="barra">/</span><span class="divisor">' + (100 - notap) + '</span></div></span>');
