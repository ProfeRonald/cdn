$(document).ready(function () {
  ...
  var mesp = $("#datos_js").attr("mesp");
  var ponderacion_academica = $("#datos_js").attr("ponderacion_academica");
  var calificaciones_por_indicadores = $("#datos_js").attr("calificaciones_por_indicadores");
  var sql_d = $("#datos_js").attr("sql_d");
...
function BotonesRecuperacionPedagogica(){
 ...
 $(".sizecal[size=a] img").show();
  ...
  function estadisticaAsistenciaHoy(){
    ...
    $('#presencias_varones_registro').val(testados['1-P'] + testados['1-T']);
    $('#excusas_varones').text(testados['1-E']);
    $('#tardanzas_varones').text(testados['1-T']);
    $('#ausencias_varones').text(testados['1-A'] + testados['1-E']);
    $('#total_varones').text(Number($('#presencias_varones').text()) + Number($('#ausencias_varones').text()));
    ...
    $('#presencias_hembras_registro').val(testados['2-P'] + testados['2-T']);
    $('#excusas_hembras').text(testados['2-E']);
    $('#tardanzas_hembras').text(testados['2-T']);
    $('#ausencias_hembras').text(testados['2-A'] + testados['2-E']);
    $('#total_hembras').text(Number($('#presencias_hembras').text()) + Number($('#ausencias_hembras').text()));
