...
if (sqlq == 1) {
  var ruta = 'imagenes/fotos/directores/foto_'+idq+'.jpg';
} else if (sqlq == 2) {
  var ruta = 'imagenes/logos/otros/logo_'+idq+'.png';
} else if (sqlq == 3) {
  var ruta = 'imagenes/banners/banner_'+idq+'.png';
} else {
  var ruta = 'imagenes/fotos/personal/foto_'+idq+'.jpg';
}
  ...
  $.ajax({
    ...
    .done(function (e) {
      if(e == 1){
        imagenSubida(urlcdn + '/' + ruta, cmini);
