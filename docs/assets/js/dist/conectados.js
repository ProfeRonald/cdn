    ...
    $('.estudiantes-conectados-grupo').parent().removeAttr('title');
        ...
        web.database().ref("enlinea/" + escuela_sesion + "/conectados").on("value", (enlineas) => {
            enlineas.forEach(function (online) {
                ...
                $('#personal-conectados-' + online.key).parent().attr('conectado', 1);
                $('#personal-conectados-grid-' + online.key).parent().attr('conectado', 1);
                ...
                $('#estudiantes-conectados-grupo-' + online.key).parent().attr('title', 'Conectado');
                    ...
                    $('#personal-conectados-' + online.key).parent().removeAttr('conectado');
                    $('#personal-conectados-grid-' + online.key).parent().removeAttr('conectado');
