                 ...
                 if (id_grupo != undefined && id_usuario != undefined) {
                               ...
                               if (persona.val().conectado == 1 || persona.val().conectado == 2) {
                                ...
                                if(hacetiempo != NaN){
                                 ...
                                 econectados +=
                                   ...
                                   '/fotos/foto.jpg" alt="' +
                                   nombre +
                                   '" data-container="#contactos" rel="tooltip" data-html="true" title="' + desde +
                                 ...
                                 econectados +=
                                   ...
                                   '/fotos/foto.jpg" alt="' +
                                   nombre +
                                   '" data-container="#contactos" rel="tooltip" data-html="true" title="&Uacute;ltima conexi&oacute;n hace ' +
                                   HaceTiempo(
                   ...
                   $(document).on("click", "#btnEnviar", function () {
                     ...
                     if (mensaje_chat.text().length > 0) {
                       ...
                       chat_mensaje = $.parseHTML(chat_mensaje);
                       chat_mensaje = $(chat_mensaje).text();
                       ...
                       if(chat_mensaje.substr(0, 4) == 'http'){
                         chat_mensaje = ' ' + chat_mensaje;
                       }
                       chat_mensaje = chat_mensaje.replaceAll('%20', ' ');
                       chat_mensaje = chat_mensaje.replaceAll('&nbsp;', ' ');
                       chat_mensaje = MsjImg(chat_mensaje);
                       chat_mensaje = MsjYouTube(chat_mensaje);
                       chat_mensaje = MsjLink(chat_mensaje, nle);
                   ...
                   function UltimoMsj(mensajes) {
                     ...
                     mensajes.forEach(function (msjs) {
                       ...
                       if (
                         ...
                         $("#key-" + msjs.key).html(
                           '<i class="verlectores fa fa-check d-block m-0 p-0 text-primary" aria-hidden="true" style="font-size: 0.7rem;cursor:pointer;" data-container="#chats" rel="tooltip" title="Mensaje le&iacute;do" data-toggle="modal" data-target="#msjs-lectores" key="' +
                             msjs.key +
                             '" ent="' +
                   ...
                   function ListarUltimoMsj() {
                     $("#chats").html(
                       '<div id="chats-refresh" class="text-center" style="font-size:1rem"><i class="fa fa-refresh rotar" aria-hidden="true" style="font-size:2rem"></i> Cargando mensjaes...</div><a href="#" id="focuschat" focus="3"></a><div class="text-right" id="boton_abajo" style="display:block" resp=""><span id="abajo_nuevos_msjs" class="bg-success text-white" style="display:none;"></span><div class="boton_abajo text-right" style="display:none;"><i class="fa fa-angle-double-down border fa-2x"></i></div></div>'
                     );
                     firebase
                       .database()
                           ...
                           if (
                             ...
                             if (
                               ...
                               msj_mensaje =
                                 ...
                                 '<div id="key-' +
                                 msjs.key +
                                 '" class="m-0 p-0 " style="position:absolute;right:15px"><i class="verlectores fa fa-check d-block m-0 p-0 text-primary" aria-hidden="true" style="font-size: 0.7rem;cursor:pointer" data-container="#chats" rel="tooltip" title="Mensaje le&iacute;do" data-toggle="modal" data-target="#msjs-lectores" key="' +
                                 msjs.key +
                                 '" ent="' +
                                 msj.marca_de_tiempo +
                                 '" ></i></div>';
                               ...
                               msj_mensaje =
                                 ...
                                 '<div id="key-' +
                                 msjs.key +
                                 '" class="m-0 p-0 " style="position:absolute;right:15px"></div>';
                             }
                   ...
                   if (msj.indexOf("https://youtube.com") > -1) {
                     ...
                     for (let i = 0; i < ss.length; i++) {
                       ...
                       msj = msj.replace(yt[0], '<div class="ytamplia d-inline-block border m-1 border-secondary" vyt="'+vyt+'"><img src="https://img.youtube.com/vi/' + vyt + '/mqdefault.jpg" alt="Img YouTube" /><span class="VerVideo" rel="tooltip" title="Click para ver"></span></div>');
                       }
                     }
